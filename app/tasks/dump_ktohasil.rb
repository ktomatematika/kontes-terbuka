module DumpKtoHasil
  ...
  def ktohasil_dump(contest, ktohasil_file_name)
    ...
    generate_problems(contest, solutions, long_problems)
    ...
    users.each do |user_row|
      ...
      generate_user_and_submissions(contest, username, short_problem_answers,
                                    long_submission_hashes)
    end
  end
  ...
  def generate_problems(contest, short_problem_answers, long_problems)
  ...
  def generate_user_and_submissions(contest, username, short_problem_answers,
                                    long_submission_hashes)
  ...
  def generate_short_submissions(contest, user_contest, short_problem_answers)
  ...
  def generate_long_submissions(contest, user_contest, long_submission_hashes)
