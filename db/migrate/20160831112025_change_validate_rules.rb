class ChangeValidateRules < ActiveRecord::Migration
  def change
    ...
    change_column_null :short_problems, :answer, false, 0
    change_column_null :short_submissions, :answer, false, 0
    ...
    change_column_null :long_problems, :problem_no, false, 0
    change_column_null :short_problems, :problem_no, false, 0
    change_column_null :users, :tries, false, 0
  end
end
